			    ...
			    <div className="row">
			      <div className="col-lg-12">
			        <div className="section-title-area ltn__section-title-2--- text-center">
			          <h6 className="section-subtitle section-subtitle-2 ltn__secondary-color">Popüler</h6>
			        ...
			        <div className="ltn__product-item ltn__product-item-4 text-center---">
			          <div className="product-img go-top">
			            ...
			            <div className="product-badge">
			              <ul>
			                <li className="sale-badge bg-green">ARS-03</li>
			              </ul>
			            </div>
			            <div className="product-img-location-gallery">
			              ...
			              <div className="product-img-gallery go-top">
			                <ul>
			                  <li>
			                    <Link to="/product-details"><i className="fas fa-camera" /> 42</Link>
			                  </li>
			                  <li>
			          ...
			          <div className="product-info">
			            ...
			            <div className="product-description">
			              <p>Patara merkezde bulunan kiralık balayı villası modern tarzıyla ,size özel havuzu romantik jakuzisi ve geniş bahçesi ile hayallerinizdeki balayı tatilini unutulmaz kılacaktır.</p>
			            </div>
			            <ul className="ltn__list-item-2 ltn__list-item-2-before">
			              ...
			              <li><span>69 <i className="flaticon-square-shape-design-interface-tool-symbol" /></span>
			                m2
			              </li>
			            </ul>
			          </div>
